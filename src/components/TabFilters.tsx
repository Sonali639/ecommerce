...
const DATA_sortOrderRadios = [
  ...
  { name: "Latest First", id: "latest" },
  { name: "Oldest First", id: "oldest" },
  { name: "Price Low - Hight", id: "lowest_price" },
  { name: "Price Hight - Low", id: "highest_price" },
];
...
const TabFilters: React.FC<TabFiltersProps> = ({ onFiltersChange }) => {
  ...
  const [rangePrices, setRangePrices] = useState([0, 500000]);
  const [categoriesState, setCategoriesState] = useState<string[]>([]);
  const [colorsState, setColorsState] = useState<string[]>([]);
  const [sizesState, setSizesState] = useState<string[]>([]);
  const [sortOrderStates, setSortOrderStates] = useState<string>("");
  useEffect(() => {
    console.log("Filters updated in TabFilters:", {
  ...
  }, [categoriesState, colorsState, sizesState, sortOrderStates, rangePrices, isOnSale]);
