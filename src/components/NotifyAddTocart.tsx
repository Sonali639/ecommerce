...
import { formatPriceWithSymbol, truncateDescription } from "@/common/common";
        ...
        <div className="ml-4 flex flex-1 flex-col">
          <div>
            <div className="flex justify-between ">
              <div>
                <h3 className="text-base font-medium ">  {truncateDescription(name,32)}</h3>
              ...
              <Prices price={formatPriceWithSymbol(price)} className="mt-0.5" />
            </div>
          </div>
